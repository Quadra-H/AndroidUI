...
import com.ssm.quadrah.diymarket.messageEndpoint.MessageEndpoint;
import com.ssm.quadrah.diymarket.messageEndpoint.model.CollectionResponseMessageData;
import com.ssm.quadrah.diymarket.messageEndpoint.model.MessageData;
...
public class RegisterActivity extends Activity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    Button regButton = (Button) findViewById(R.id.btnBuy);
  ...
  private void updateState(State newState) {
    Button registerButton = (Button) findViewById(R.id.btnBuy);
    switch (newState) {
    case REGISTERED:
  ...
  private class QueryMessagesTask 
    ...
    protected void onPostExecute(CollectionResponseMessageData messages) {
      ...
      if (exceptionThrown != null) {
        ...
        TextView messageView = (TextView) findViewById(R.id.textViewCost);
